...
#import "DriverHistoryViewController.h"

@interface DriverHistoryViewController ()

@end

@implementation DriverHistoryViewController
...
- (void)viewDidLoad
{
    ...
    [self.openBookingButton setTitle:@"ACTIVE JOB" forState:UIControlStateNormal];
    ...
    [self.historyButton setTitle:@"PREVIOUS JOBS" forState:UIControlStateNormal];
